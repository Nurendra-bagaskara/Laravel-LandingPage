...
<html class="no-js" lang="en">
  <head>
    ...
    <!-- add alt layout here -->
    <link rel="stylesheet" href="./css/style-commodity.css" />
  ...
  <body id="menu" class="body-page">
    ...
    <main class="page-main page-fullpage main-anim" id="mainpage">
          ...
          <div class="slide-wrapper">
            <div class="item-wrapper">
              ...
              <div class="legend section-content">
                <div class="row">
                  <h3 class="display-decor display-title">LANDING PAGE COMMODITY</h3>
      ...
      <!-- Begin of About -->
      <div style="background-image: url(./img/bg-commodity.png); background-repeat: repeat-y; background-size: contain" class="section section-twoside services-slider fp-auto-height-responsive anim-slide" data-section="About">
        <div class="slide">
          <div class="slide-wrapper">
            <div class="item-wrapper anim">
              <div style="background-color: #1e2529" class="container">
                ...
                <div class="section-cover-tier left fit">
                  ...
                  <h3 class="mt-4 mb-5 display-4 display-decor anim-1">Commodity</h3>
                      ...
                      <div class="vertikal_center col-12 col-lg-6 text-left">
                        <div class="wrapper">
                          ...
                          <div class="title-desc mt-5">
                            <p>
                              We work closely with local farmers in Indonesia. We can supply various commodities from vanilla beans, coffee, spices, and many more. We carefully grade our products, making our products suitable for export.
                            </p>
      ...
      <div
        style="background-image: url(./img/bg-commodity1.png); background-repeat: repeat-y; background-size: contain; background-position: right"
        ...
        <div class="section-wrapper fullwidth">
          ...
          <div class="section-content anim">
            <div style="background-color: #1e2529" class="container">
              <!-- bagian combin -->
              <div class="illustr">
                <div class="section-cover-tier left fit bg-img" data-image-src="./img/img-commodity1.png"></div>
              </div>
              <!-- Begin of section wrapper -->
              <div class="section-wrapper fullwidth fullheight padding-wrapper-topbottom">
                <!-- content -->
                  ...
                  <div class="row justify-content-between">
                    ...
                    <div class="col-12 col-lg-6 text-left">
                      <div class="wrapper">
                        <!-- title and description -->
                        <div class="title-desc">
                          <h2 class="display-4 display-title display-decor anim-1">Vanilla Beans</h2>
                          <p class="anim-2">
                            We provide two types of vanilla beans: Tahiti and Planifolia, found in various regions in Indonesia. Vanilla beans benefit raw materials in the food & beverage, cosmetic, and pharmaceutical fields.
                          </p>
                        </div>
                      </div>
            ...
            <div style="background-color: #1e2529" class="container">
              ...
              <div class="slide" id="information" data-anchor="information">
                ...
                <div class="section-wrapper padding-wrapper-topbottom">
                  <div class="illustr">
                    <div class="section-cover-tier right fit bg-img" data-image-src="img/img-commodity2.png"></div>
                  </div>
                  <!-- content -->
                  <div class="section-content anim">
                    <!-- main content -->
                        ...
                        <div class="">
                          ...
                          <div class="title-desc">
                            <div class="anim-2">
                              ...
                              <p>
                                We provide two types of coffee beans: Arabica and Robusta, which can be adjusted to your needs. Our Coffee Beans come from various regions in Indonesia, which have their uniqueness in each area to have
      ...
      <div class="section section-home fp-auto-height-responsive border-sm section-centered" data-section="about-more-two">
        ...
        <div class="section-wrapper fullwidth">
          ...
          <div class="section-content anim">
            <div style="background-color: #1e2529" class="container">
              <!-- bagian combin -->
              <div class="section-cover-tier left fit bg-img" data-image-src="./img/img-commodity3.png"></div>
              <!-- Begin of section wrapper -->
              <div class="section-wrapper fullwidth fullheight padding-wrapper-topbottom">
                <!-- content -->
                <div class="section-content anim">
                  <div class="row justify-content-between">
                    ...
                    <div class="col-12 col-lg-6 text-left">
                      <div class="wrapper">
                        <!-- title and description -->
                        <div class="title-desc">
                          <h2 class="display-4 display-title display-decor anim-1">Spices & Herbs</h2>
                          <p class="anim-2">
                            We provide various spices originating from Indonesia, ranging from cat whiskers, cloves, nutmeg, pepper, ginger, turmeric, etc. Herbs in Indonesia have many benefits, such as warming the body, as food
                            preservatives, flavour enhancers, and ingredients for medicine.
                          </p>
                          <hr class="border light" />
                        </div>
                      </div>
          ...
          <div class="section-content fullwidth anim">
            <div class="row">
              <div class="col-12 text-center">
                <h1 class="display-4 display-title display-decor">And Many More</h1>
              </div>
            </div>
          </div>
          <!-- End of section wrapper -->
      ...
      <!-- End of All Size-->
       ...
       <div style="background-image: url(./img/bg-commodity2.png); background-repeat: repeat-y; background-size: contain; background-position: right" class="section section-centered" data-section="contact">
        ...
        <div class="section-content col-md-6">
          ...
          <div class="container">
            <!--Card-->
            <div style="background-color: #1e2529" class="card">
              <!--Card content-->
              <div class="card-body">
                <!--Section heading-->
